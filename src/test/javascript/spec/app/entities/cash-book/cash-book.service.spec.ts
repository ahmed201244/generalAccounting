...
import { ICashBook, CashBook, TransactionType } from 'app/shared/model/cash-book.model';
...
describe('Service Tests', () => {
    describe('CashBook Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new CashBook(0, currentDate, 0, TransactionType.CREDIT, 'AAAAAAA');
        });
