...
import { GeneralAccountComponent } from 'app/entities/general-account/general-account.component';
...
describe('Component Tests', () => {
    describe('GeneralAccount Management Component', () => {
        let comp: GeneralAccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GeneralAccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.generalAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
