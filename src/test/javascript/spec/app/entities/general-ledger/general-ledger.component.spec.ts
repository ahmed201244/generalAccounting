...
import { GeneralLedgerComponent } from 'app/entities/general-ledger/general-ledger.component';
...
describe('Component Tests', () => {
    describe('GeneralLedger Management Component', () => {
        let comp: GeneralLedgerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GeneralLedgerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.generalLedgers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
