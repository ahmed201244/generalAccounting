...
import { TrialBalanceComponent } from 'app/entities/trial-balance/trial-balance.component';
...
describe('Component Tests', () => {
    describe('TrialBalance Management Component', () => {
        let comp: TrialBalanceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TrialBalanceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.trialBalances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
